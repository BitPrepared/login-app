package com.costigiola.lib;

import java.util.ArrayList;

import costigiola.lib.R;
...
public class Costigiola_loginActivity extends Activity {
...
//	        riempiRagazzi();
	        ...
	        ragazzi.add(new Ragazzi("martino","mogna",Ragazzi.Rossi));
	 		...
	 		ragazzi.add(new Ragazzi("chiara","saltarelli",Ragazzi.Gialli));
	 		ragazzi.add(new Ragazzi("silvia","picchieri",Ragazzi.Gialli));
...
//	 		ragazzi.add(new Ragazzi("arianna","casaroli",Ragazzi.Verdi));
	        ...
	        btnLogin.setOnClickListener(new OnClickListener() {
			   ...
			   public void onClick(View v) {
				...
				Ragazzi allievo = new Ragazzi(txtUserName.getText().toString().toLowerCase(), txtCognome.getText().toString().toLowerCase());
			    int index=ragazzi.indexOf(allievo);
			    
			    if(index>-1){
			    	   allievo = ragazzi.get(index);
			           Intent intent = new Intent(Costigiola_loginActivity.this, CostigiolaSq.class);
